namespace DiplomDokumentooborot.Forms.Zayavki
{
    partial class DogovorSait
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "DogovorSait";
            this.Text = "Заполнение шаблона договора на разработку сайта";
            this.Load += new System.EventHandler(this.DogovorSait_Load);
